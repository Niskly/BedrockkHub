...
(function() {
    const themes = {
        red: {
            ...
            '--bg-image': 'url("https://whxmfpdmnsungcwlffdx.supabase.co/storage/v1/object/public/bgs/red.png")'
        },
        purple: {
            '--brand-1': '#8b5cf6',
            '--brand-2': '#6d28d9',
            '--shadow-brand': '0 12px 30px rgba(139, 92, 246, .22)',
            '--bg-image': 'url("https://whxmfpdmnsungcwlffdx.supabase.co/storage/v1/object/public/bgs/purplebg.png")'
        },
        green: {
            '--brand-1': '#22c55e',
            '--brand-2': '#15803d',
            '--shadow-brand': '0 12px 30px rgba(34, 197, 94, .22)',
            '--bg-image': 'url("https://whxmfpdmnsungcwlffdx.supabase.co/storage/v1/object/public/bgs/greenbg.png")'
        },
        blue: {
            '--brand-1': '#3b82f6',
            '--brand-2': '#2563eb',
            '--shadow-brand': '0 12px 30px rgba(59, 130, 246, .22)',
            '--bg-image': 'url("https://whxmfpdmnsungcwlffdx.supabase.co/storage/v1/object/public/bgs/bluebg.png")'
        },
        black: {
            '--brand-1': '#e5e7eb',
            '--brand-2': '#9ca3af',
            '--shadow-brand': '0 12px 30px rgba(229, 231, 235, .1)',
            '--bg-image': 'url("https://whxmfpdmnsungcwlffdx.supabase.co/storage/v1/object/public/bgs/graybg.png")'
        }
    };
